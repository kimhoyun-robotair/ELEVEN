...
class TestbedRuntime:
    ...
    def _build_panel(self):
        self.window = ui.Window("Elevator controls", width=360, height=600, position_x=1030, position_y=240)
            ...
            with ui.ScrollingFrame():
                with ui.VStack(spacing=9, height=0):
                            ...
                            with ui.VStack(spacing=5, height=0):
                                ...
                                for floor in range(len(rig.heights)):
                                    with ui.HStack(height=25, spacing=4):
                                        ...
                                        if floor > 0:
                                            ui.Button("Call down", clicked_fn=lambda e=elevator_id, f=floor: self.press(e, "hall", f, "down"))
                    ...
                    ui.Label("Alarm is a local indicator; it does not contact a service.\n"
                             "Pause freezes simulation. Stop ends this run.",
