"""Deterministic, dependency-free elevator controller for the USD elevator rigs.

API
---
ElevatorController(floor_heights, initial_floor=0, max_speed=0.7,
                   acceleration=0.5, door_seconds=1.8, dwell_seconds=3.0)
...
Snapshot keys: state, floor, targetFloor,
